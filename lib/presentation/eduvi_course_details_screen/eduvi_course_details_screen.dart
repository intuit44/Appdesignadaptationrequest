...
import 'notifier/eduvi_course_details_notifier.dart';
          ...
          Consumer(
            builder: (context, ref, _) {
              return ListView.separated(
                ...
                itemCount: ref
                        .watch(eduviCourseDetailsNotifier)
          ...
          Consumer(
            builder: (context, ref, _) {
              return CustomTextFormField(
                controller:
                    ref.watch(eduviCourseDetailsNotifier).emailController,
