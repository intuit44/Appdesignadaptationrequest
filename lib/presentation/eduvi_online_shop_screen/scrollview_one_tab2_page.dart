...
import 'notifier/eduvi_online_shop_notifier.dart';
...
class ScrollviewOneTab2Page extends ConsumerStatefulWidget {
  const ScrollviewOneTab2Page({Key? key}) : super(key: key);
          ...
          Consumer(
            builder: (context, ref, _) {
              return CustomSearchView(
                controller: ref.watch(eduviOnlineShopNotifier).searchController,
    ...
    return Consumer(
      builder: (context, ref, _) {
        return CustomTextFormField(
          controller:
              ref.watch(eduviOnlineShopNotifier).subscribeEmailInputController,
