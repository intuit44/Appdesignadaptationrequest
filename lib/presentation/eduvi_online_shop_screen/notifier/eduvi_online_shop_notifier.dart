...
import '../models/eduvi_online_shop_model.dart';
...
part 'eduvi_online_shop_state.dart';

final eduviOnlineShopNotifier = StateNotifierProvider.autoDispose<
  EduviOnlineShopNotifier,
  EduviOnlineShopState
>(
  (ref) => EduviOnlineShopNotifier(
    EduviOnlineShopState(
